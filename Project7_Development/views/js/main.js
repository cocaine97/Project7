...
var resizePizzas = function(size) {
    ...
    //Took out dx and newwidth out of the for loop and only used width of one pizza rather than iterating over everyone for no reason , seems to be working fine
...
function updatePositions() {
    ...
    // Moved the "phase" out of loop and split into two variables . Both decide the direction of the pizzas
    // Was trying to figure out how to make the animation vanilla then saw it wasn't in the rubric so :P
    var items = document.querySelectorAll('.mover');
    var phase1 = Math.sin((document.body.scrollTop / 550) + Math.random() * 0.03);
    var phase2 = -phase1;
